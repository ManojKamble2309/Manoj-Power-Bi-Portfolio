...
This repository contains a collection of **interactive Power BI dashboards** created using different datasets. These projects demonstrate my skills in **data visualization, business intelligence, and data analysis**.

Each dashboard focuses on transforming raw data into meaningful insights that help understand trends, patterns, and business performance.
...
I am an **aspiring Data Analyst** passionate about analyzing data and building interactive dashboards using **Power BI, Excel, and SQL**.  
I enjoy turning raw data into meaningful insights that support **data-driven decision making**.
...
- Total servings of beer, wine, and spirits
- Country-wise alcohol consumption comparison
...
- Sales distribution by taco type
- Weekend tips comparison
- Restaurant performance summary

### Tools Used
Power BI, Business Analysis, Data Visualization
...
- Yearly trading values
- Stock price movement trends
- Trading value vs stock price analysis

### Tools Used
Power BI, Financial Data Analysis, Time Series Visualization
...
### Key Insights
- Total followers and engagement score
- Tweet and retweet volume trends
- Top users with highest activity
- Average tweet length

### Tools Used
Power BI, Social Media Analytics, Data Visualization
...
- User activity by media type
- Followers and user insights
...
- Top hashtags by user friend count
- Tweet activity over time
- Detailed user tweet summary
